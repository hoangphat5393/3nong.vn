...
@section('content')
    ...
    <div class="app-content">
        <div class="container-fluid">
            <form action="{{ $id > 0 ? route('admin.product.update', $id) : route('admin.product.store') }}" method="POST"
                id="frm-create-product" enctype="multipart/form-data">
                @if ($id > 0)
                    @method('PUT')
                @endif
                ...
                <div class="row">
                    <div class="col-md-9">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="vi" role="tabpanel"
                                        ...
                                        <div class="mb-3 form-group">
                                            ...
                                            <input type="text" class="form-control slug_slugify" id="slug"
                                                name="slug" placeholder="Slug" value="{{ $slug ?? '' }}">
                                            @if ($id > 0)
                                                <p><b style="color: #0000cc;">Link:</b>
                                                    <u><i><a style="color: #F00;"
                                                                href="{{ route('product.detail', [$slug, $id]) }}"
                                                                target="_blank">{{ route('product.detail', [$slug, $id]) }}</a></i></u>
                                                </p>
                                            @endif
                                        </div>
                                        ...
                                        <div class="mb-3 form-group">
                                            ...
                                            <input type="text" class="form-control title_slugify" id="title"
                                                name="name" placeholder="Tiêu đề" value="{{ $name ?? '' }}">
                                        </div>
                                        <hr>
                                        @php
                                            $quote_arr = [
                        ...
                        @include('backend.product.includes.price_stock_single', ['price_type' => $price_type])
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-4 card card-secondary card-outline widget-category">
                            ...
                            <div class="card-body max-vh-75">
                                <div class="inside clearfix">
                                    @php
                                        $array_checked = isset($product_detail)
                                            ? $product_detail->categories->pluck('id')->toArray()
                                            : [];
                        ...
                        @include('backend.partials.image', [
                            'title' => 'Ảnh đại diện',
                            'id' => 'img',
                            'name' => 'image',
                            'image' => $image ?? '',
