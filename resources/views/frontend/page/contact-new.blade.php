...
@section('seo')
    @include('frontend.layouts.seo', [
        ...
        'description' => 'Thông tin liên hệ, hotline tư vấn và bản đồ địa chỉ mua sắm thực phẩm sạch tại Tam Nông.',
    ...
    <div class="contact-card-block">
        ...
        <div class="contact-hero-card">
            ...
            <p class="contact-hero-desc">
                Tam Nông luôn sẵn sàng lắng nghe, tư vấn thực phẩm tươi sạch và giải đáp mọi yêu cầu đặt hàng, hợp tác đại lý nhanh chóng và tận tình nhất.
            </p>
        </div>
            ...
            <div class="row g-4 g-lg-5">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="contact-info-list">
                        ...
                        <div class="contact-info-item">
                            ...
                            <div>
                                ...
                                <div class="contact-info-value">{{ setting_option('address', 'Số 66 đường 40, P. Hiệp Bình Chánh, TP. Thủ Đức, TP. Hồ Chí Minh') }}</div>
                            </div>
                        </div>
                        ...
                        <div class="contact-info-item">
                            ...
                            <div>
                                ...
                                <div class="contact-info-value">
                                    <a href="tel:{{ str_replace(' ', '', setting_option('phone', '0932 009 180')) }}" class="text-success text-decoration-none fw-bold fs-5">
                        ...
                        <div class="contact-info-item">
                            ...
                            <div>
                                ...
                                <div class="contact-info-value">
                                    <a href="mailto:{{ setting_option('email', 'tamnong.corp@gmail.com') }}" class="text-muted text-decoration-none">
                    ...
                    <div class="fast-action-card text-center">
                        <h4 class="h6 fw-bold mb-2"><i class="fa-solid fa-comments me-1"></i> Cần Tư Vấn Đặt Hàng Gấp?</h4>
                        <p class="small text-white-50 mb-3">Kết nối trực tiếp qua Zalo hoặc Hotline để được phản hồi trong vòng 5 phút.</p>
                        <div class="d-flex justify-content-center gap-2 flex-wrap">
                            <a href="https://zalo.me/{{ str_replace(' ', '', setting_option('phone', '0932 009 180')) }}" target="_blank" class="btn btn-light btn-sm px-3 rounded-pill fw-bold text-primary">
                                <i class="fa-solid fa-comment-dots me-1"></i> Chat Zalo Ngay
                            </a>
                            <a href="tel:{{ str_replace(' ', '', setting_option('phone', '0932 009 180')) }}" class="btn btn-warning btn-sm px-3 rounded-pill fw-bold text-dark">
                        ...
                        <form id="contact_form" method="post" action="{{ route('contact.submit') }}" novalidate="novalidate">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="contact[name]" id="contact_name" class="form-control form-control-custom" placeholder="Ví dụ: Nguyễn Văn A" required value="{{ old('contact.name') }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label-custom">Số điện thoại <span class="text-danger">*</span></label>
                                    <input type="tel" name="contact[phone]" id="contact_phone" class="form-control form-control-custom" placeholder="Ví dụ: 0932 009 180" required value="{{ old('contact.phone') }}">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="contact[email]" id="contact_email" class="form-control form-control-custom" placeholder="email@example.com" value="{{ old('contact.email') }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label-custom">Địa chỉ nhận hàng / khu vực</label>
                                    <input type="text" name="contact[address]" id="contact_address" class="form-control form-control-custom" placeholder="Quận / Huyện, Tỉnh thành" value="{{ old('contact.address') }}">
                                </div>
                            </div>

                            <div class="mb-4">
                                <label class="form-label-custom">Nội dung yêu cầu / Lời nhắn <span class="text-danger">*</span></label>
                                <textarea name="contact[content]" id="contact_content" rows="4" class="form-control form-control-custom" placeholder="Quý khách vui lòng ghi rõ loại thực phẩm hoặc dịch vụ cần tư vấn..." required>{{ old('contact.content') }}</textarea>
                            </div>
    ...
    @if (setting_option('google_map'))
        <div class="contact-card-block p-4">
            ...
            <div class="rounded-4 overflow-hidden border" style="height: 380px;">
                <iframe src="{{ setting_option('google_map') }}" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
        </div>
    @endif
</div>
