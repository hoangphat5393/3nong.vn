            ...
            <div class="row g-4 align-items-start">
                ...
                <div class="col-lg-7">
                    ...
                    <p class="text-muted leading-relaxed mb-4">
                        Tam Nông cung cấp các gói hợp tác phân phối thực phẩm sạch linh hoạt, phù hợp với mọi quy mô từ cửa
                        hàng bán lẻ tới đại lý độc quyền tỉnh thành.
                    </p>
                    ...
                    <div class="package-card-2">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted small mb-2">Dành cho các nhà phân phối có kho bãi hoặc phương tiện vận
                                    chuyển tại các quận/huyện, tỉnh thành.</p>
                    ...
                    <div class="package-card-2">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted small mb-2">Dành cho các điểm bán lẻ thực phẩm sạch, bách hóa, siêu thị
                                    tiện lợi.</p>
                                <ul class="small text-secondary mb-0 ps-3">
                    ...
                    <div class="package-card-2">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted small mb-2">Cung cấp nguyên liệu thực phẩm định kỳ cho bếp ăn công
                                    nghiệp, quán ăn đặc sản.</p>
                                <ul class="small text-secondary mb-0 ps-3">
                    ...
                    <div class="bg-white p-4 rounded-4 border shadow-sm mt-4">
                        <h3 class="h6 fw-bold text-success text-uppercase mb-3"><i
                                class="fa-solid fa-circle-check me-2"></i> Cam Kết Từ Tam Nông</h3>
                        <div class="row g-3 small text-muted">
                            <div class="col-sm-6">
                                <i class="fa-solid fa-check text-success me-1"></i> Đổi trả 1-1 nếu hàng không đạt chất
                                lượng.
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <i class="fa-solid fa-check text-success me-1"></i> Hạn mức công nợ linh hoạt cho đại lý
                                thân thiết.
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5">
                    <div class="sticky-form-box-2">
                        ...
                        <form id="agent_form_2" method="post" action="{{ route('contact.submit') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="contact[name]" id="agent2_name" class="form-control py-2"
                            ...
                            <div class="mb-3">
                                <label class="form-label small fw-bold text-secondary">Số điện thoại / Zalo <span
                                        class="text-danger">*</span></label>
                                <input type="tel" name="contact[phone]" id="agent2_phone" class="form-control py-2"
                                    placeholder="Số điện thoại nhận báo giá sỉ" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label small fw-bold text-secondary">Khu vực / Tỉnh thành <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="contact[address]" id="agent2_address" class="form-control py-2"
                                    placeholder="Ví dụ: Quận Bình Thạnh, TP.HCM" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label small fw-bold text-secondary">Email nhận bảng giá</label>
                                <input type="email" name="contact[email]" id="agent2_email" class="form-control py-2"
                                    placeholder="Email của bạn (không bắt buộc)">
                            </div>

                            <div class="mb-4">
                                <label class="form-label small fw-bold text-secondary">Mặt hàng quan tâm & Ghi chú <span
                                        class="text-danger">*</span></label>
                                <textarea name="contact[content]" id="agent2_content" rows="3" class="form-control py-2"
                                    placeholder="Ví dụ: Cần tư vấn mở đại lý thịt bê và gà đồi..." required></textarea>
                            </div>

                            <button type="button"
                                class="btn btn-success btn-agent2-submit w-100 py-3 rounded-pill fw-bold shadow">
                                <i class="fa-solid fa-paper-plane me-1"></i> Gửi Đăng Ký Đại Lý
                            </button>

                            <div class="text-center mt-3 small text-muted">
                                Hoặc liên hệ Hotline B2B: <a
                                    href="tel:{{ str_replace(' ', '', setting_option('phone', '0932 009 180')) }}"
                                    class="text-success fw-bold text-decoration-none">{{ setting_option('phone', '0932 009 180') }}</a>
                            </div>
                        </form>
                    </div>
                </div>
