...
@section('seo')
    @include('frontend.layouts.seo', [
        ...
        'description' => 'Chính sách đại lý phân phối thực phẩm sạch Tam Nông - Chiết khấu cao, nguồn hàng ổn định.',
...
<div class="bg-warning text-dark py-2 px-3 text-center fw-bold border-bottom shadow-sm">
    ...
    <span class="ms-2 small text-muted d-none d-md-inline">(Giới thiệu quyền lợi, danh mục hàng, quy trình & form đăng ký)</span>
...
<div class="agent-wrapper-1">
    ...
    <section class="agent-hero-1 pt-3 pb-5">
        <div class="container">
            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    <span class="badge bg-white bg-opacity-20 text-warning px-3 py-2 rounded-pill fw-bold text-uppercase mb-3 d-inline-block">
                    ...
                    <p class="lead text-white text-opacity-90 mb-4 fs-6 lh-base">
                        Chính sách chiết khấu hấp dẫn lên tới <strong>35%</strong>, nguồn hàng phong phú tận gốc trang trại, hỗ trợ quảng bá và giao hàng chuyên nghiệp mỗi ngày.
                    </p>
                    <div class="d-flex gap-3 flex-wrap align-items-center">
                        ...
                        <a href="tel:{{ str_replace(' ', '', setting_option('phone', '0932 009 180')) }}" class="btn btn-outline-light px-4 py-3 rounded-pill fw-bold">
                            <i class="fa-solid fa-phone me-1"></i> Hotline: {{ setting_option('phone', '0932 009 180') }}
                        </a>
                    </div>
                </div>
                <div class="col-lg-5 text-center">
                    <img src="{{ asset('assets/images/about_supply_chain.jpg') }}" alt="Hợp tác đại lý Tam Nông" class="img-fluid rounded-4 shadow-lg border border-3 border-white">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5">
        <div class="container">
            <div class="text-center mb-5">
                <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 rounded-pill fw-bold text-uppercase mb-2">Quyền lợi đặc quyền</span>
                <h2 class="h3 fw-bold text-dark">Tại Sao Nên Trở Thành Đại Lý Của Tam Nông?</h2>
                <p class="text-muted">Chúng tôi mang đến giải pháp nguồn hàng an tâm cùng chính sách kinh doanh bền vững nhất</p>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3">
                    <div class="benefit-card-1">
                        ...
                        <p class="text-muted small mb-0">Giá sỉ tận gốc trang trại, không qua trung gian. Đảm bảo biên độ lợi nhuận kinh doanh cao và thưởng doanh số định kỳ.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="benefit-card-1">
                        ...
                        <p class="text-muted small mb-0">Thực phẩm tươi sạch, có đầy đủ giấy kiểm định VSATTP, hóa đơn chứng từ rõ ràng, nâng cao uy tín cho cửa hàng của bạn.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="benefit-card-1">
                        ...
                        <p class="text-muted small mb-0">Đội xe đông lạnh chuyên dụng vận chuyển hàng ngày, đảm bảo thực phẩm tới tay đại lý luôn giữ trọn độ tươi sống.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="benefit-card-1">
                        ...
                        <p class="text-muted small mb-0">Cung cấp tư liệu hình ảnh, video sản phẩm, tài liệu bán hàng và hỗ trợ chuyển khách hàng lẻ khu vực về cho đại lý.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5 bg-white border-top border-bottom">
        <div class="container">
            <div class="text-center mb-5">
                <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 rounded-pill fw-bold text-uppercase mb-2">Sản phẩm phân phối</span>
    ...
    <section class="py-5">
        <div class="container">
            <div class="text-center mb-5">
                <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 rounded-pill fw-bold text-uppercase mb-2">Quy trình hợp tác</span>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="bg-white p-4 rounded-4 shadow-sm h-100 border">
                        ...
                        <p class="text-muted small mb-0">Điền form đăng ký phía dưới hoặc liên hệ trực tiếp hotline phòng kinh doanh.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="bg-white p-4 rounded-4 shadow-sm h-100 border">
                        ...
                        <p class="text-muted small mb-0">Chuyên viên liên hệ gửi bảng giá chiết khấu, chính sách và tư vấn gói hợp tác phù hợp.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="bg-white p-4 rounded-4 shadow-sm h-100 border">
                        ...
                        <p class="text-muted small mb-0">Thống nhất các điều khoản quyền lợi, hạn mức công nợ và ký kết hợp tác chính thức.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="bg-white p-4 rounded-4 shadow-sm h-100 border">
                        ...
                        <p class="text-muted small mb-0">Tam Nông tiến hành giao chuyến hàng đầu tiên và đồng hành hỗ trợ kinh doanh liên tục.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-9">
                    <div class="form-agent-box-1">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted small">Vui lòng điền thông tin để chuyên viên kinh doanh Tam Nông gửi báo giá sỉ ưu đãi nhất trong vòng 15 phút.</p>
                        </div>

                        <form id="agent_form_1" method="post" action="{{ route('contact.submit') }}" novalidate="novalidate">
                            @csrf
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-secondary">Họ và tên của bạn <span class="text-danger">*</span></label>
                                    <input type="text" name="contact[name]" id="agent1_name" class="form-control py-2" placeholder="Ví dụ: Nguyễn Văn A" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-secondary">Số điện thoại / Zalo <span class="text-danger">*</span></label>
                                    <input type="tel" name="contact[phone]" id="agent1_phone" class="form-control py-2" placeholder="Số điện thoại nhận báo giá" required>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="contact[email]" id="agent1_email" class="form-control py-2" placeholder="Email của bạn (không bắt buộc)">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-secondary">Khu vực / Tỉnh thành kinh doanh <span class="text-danger">*</span></label>
                                    <input type="text" name="contact[address]" id="agent1_address" class="form-control py-2" placeholder="Ví dụ: TP. Thủ Đức, TP.HCM" required>
                                </div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label small fw-bold text-secondary">Mô hình kinh doanh hiện tại</label>
                                <select name="contact[business_type]" class="form-select py-2">
                                    ...
                                    <option value="Nhà hàng / Quán ăn / Khách sạn">Nhà hàng / Quán ăn / Khách sạn</option>
                                    ...
                                    <option value="Kinh doanh Online / Khác">Kinh doanh Online / Cá nhân phân phối</option>
                                </select>
                            </div>

                            <div class="mb-4">
                                <label class="form-label small fw-bold text-secondary">Nhóm mặt hàng quan tâm & Lời nhắn <span class="text-danger">*</span></label>
                                <textarea name="contact[content]" id="agent1_content" rows="3" class="form-control py-2" placeholder="Ví dụ: Cần tư vấn báo giá sỉ thịt bê và gà đồi giao tại TP.HCM..." required></textarea>
                            </div>

                            <div class="text-center">
                                <button type="button" class="btn btn-success btn-agent1-submit px-5 py-3 rounded-pill fw-bold shadow">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (submitBtn && agentForm) {
            submitBtn.addEventListener('click', function(e) {
                ...
                submitBtn.innerHTML = '<i class="fa-solid fa-spinner fa-spin me-1"></i> Đang gửi đăng ký...';
