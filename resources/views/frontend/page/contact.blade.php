...
@section('seo')
    @include('frontend.layouts.seo', [
        ...
        'description' => setting_option('description', 'Liên hệ với Tam Nông để được tư vấn và hỗ trợ nhanh chóng'),
            ...
            <div class="bg-white p-4 rounded shadow-sm border h-100 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <p class="text-muted small mb-4">
                        Tam Nông luôn sẵn sàng lắng nghe và giải đáp mọi thắc mắc, tư vấn hỗ trợ quý khách hàng nhanh chóng và tận tình nhất.
                    </p>
                    ...
                    <div class="contact-info-list">
                        ...
                        <div class="d-flex align-items-start gap-3 mb-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted small mb-0">{{ setting_option('address', 'Số 66 đường 40, phường Hiệp Bình Chánh, Thành Phố Thủ Đức, Thành phố Hồ Chí Minh, Việt Nam') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-start gap-3 mb-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0">
                                    <a href="mailto:{{ setting_option('email', 'tamnong.corp@gmail.com') }}" class="text-muted small text-decoration-none">
                ...
                <div class="pt-3 border-top mt-3 d-flex gap-2">
                    <a href="https://zalo.me/{{ str_replace(' ', '', setting_option('phone', '0932 009 180')) }}" target="_blank" class="btn btn-outline-primary btn-sm rounded-pill flex-fill fw-bold py-2">
                        <i class="fa-solid fa-comment-dots me-1"></i> Chat Zalo
                    </a>
                    <a href="tel:{{ str_replace(' ', '', setting_option('phone', '0932 009 180')) }}" class="btn btn-success btn-sm rounded-pill flex-fill fw-bold py-2">
        ...
        <div class="col-lg-7">
            <div class="information-contact bg-white p-4 rounded shadow-sm border h-100">
                ...
                <form id="form-contact" class="form-contact" method="post" action="{{ route('contact.submit') }}" novalidate="novalidate">
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-bold text-secondary">Lời nhắn / Nội dung cần tư vấn <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="Contact_Message" name="contact[content]" placeholder="Lời nhắn hoặc yêu cầu hỗ trợ..."
                            rows="5" required>{{ old('contact.content') }}</textarea>
                    </div>
