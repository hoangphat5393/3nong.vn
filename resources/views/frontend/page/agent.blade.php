...
@section('seo')
    @include('frontend.layouts.seo', [
        ...
        'description' => setting_option('description', 'Trở thành đối tác đại lý phân phối cùng 3 Nông - Chiết khấu cao, nguồn hàng ổn định, hỗ trợ tận tình.'),
    ...
    <div class="row justify-content-center mb-4">
        <div class="col-lg-10 text-center">
            ...
            <p class="text-white text-opacity-75 mb-0" style="font-size: 15px;">
                Đồng hành phát triển cùng <strong class="text-warning">3 Nông</strong> – Nguồn cung thực phẩm sạch & vật tư nông nghiệp uy tín, chiết khấu tối ưu và chính sách hỗ trợ toàn diện.
            </p>
        </div>
    </div>
    ...
    <div class="row g-3 mb-5">
        <div class="col-6 col-md-3">
            <div class="agent-benefit-card">
                ...
                <p class="text-muted small mb-0">Chính sách giá sỉ tận gốc không qua trung gian, biên độ lợi nhuận cao cho đối tác.</p>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="agent-benefit-card">
                ...
                <p class="text-muted small mb-0">Sản phẩm có nguồn gốc rõ ràng, đạt chuẩn VSATTP, đóng gói chuyên nghiệp.</p>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="agent-benefit-card">
                ...
                <p class="text-muted small mb-0">Hệ thống vận chuyển chuyên nghiệp, đảm bảo hàng tươi mới, đúng hẹn toàn quốc.</p>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="agent-benefit-card">
                ...
                <p class="text-muted small mb-0">Cung cấp tài liệu, hình ảnh, bài viết và hỗ trợ tiếp cận khách hàng tại khu vực.</p>
            </div>
        </div>
    </div>
            ...
            <div class="bg-white p-4 rounded-3 shadow-sm border h-100 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <div class="agent-steps-list mb-4">
                        <div class="agent-step-item">
                            ...
                            <p class="text-muted small mb-0">Điền form đăng ký đại lý bên cạnh để nhận bảng báo giá sỉ và chính sách chi tiết.</p>
                        </div>
                        <div class="agent-step-item">
                            <span class="agent-step-number">2</span>
                            <h4 class="h6 fw-bold text-dark mb-1">Tư vấn chính sách & Báo giá</h4>
                            <p class="text-muted small mb-0">Chuyên viên phụ trách đại lý liên hệ tư vấn danh mục và chính sách chiết khấu tốt nhất.</p>
                        </div>
                        <div class="agent-step-item">
                            <span class="agent-step-number">3</span>
                            <h4 class="h6 fw-bold text-dark mb-1">Ký kết & Lên đơn hàng</h4>
                            <p class="text-muted small mb-0">Thống nhất hợp đồng phân phối và xác nhận đơn hàng đầu tiên với chính sách ưu đãi.</p>
                        </div>
                        <div class="agent-step-item mb-0">
                            ...
                            <p class="text-muted small mb-0">Giao hàng tận nơi và hỗ trợ marketing, bán hàng liên tục trong suốt quá trình kinh doanh.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-light p-3 rounded-3 border">
                    <div class="d-flex align-items-center gap-3">
                        <div class="flex-shrink-0 bg-success text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 46px; height: 46px; font-size: 20px;">
                            <i class="fa-solid fa-phone-volume"></i>
                        </div>
                        <div>
                            <div class="small text-muted fw-bold">HOTLINE TƯ VẤN ĐẠI LÝ 24/7</div>
                            <a href="tel:{{ str_replace(' ', '', setting_option('phone', '0932 009 180')) }}" class="text-success fw-bold fs-5 text-decoration-none">
            ...
            <div class="form-agent-card p-4 p-md-5 h-100">
                <div class="mb-4">
                    ...
                    <p class="text-muted small mb-0">
                        Vui lòng để lại thông tin, bộ phận phụ trách phát triển đại lý của 3 Nông sẽ liên hệ và gửi bảng giá sỉ đến quý khách trong vòng 30 phút.
                    </p>
                </div>
                ...
                <form id="form-agent" class="form-agent" method="post" action="{{ route('contact.submit') }}" novalidate="novalidate">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        {{-- Số điện thoại --}}
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-dark">Số điện thoại nhận báo giá <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-dark">Tỉnh / Thành phố dự kiến mở đại lý <span class="text-danger">*</span></label>
                            <input type="text" class="form-control py-2" id="Agent_Address" name="contact[address]"
                                placeholder="Ví dụ: TP.HCM, Bình Dương, Đồng Nai..." required value="{{ old('contact.address') }}">
                        </div>

                        {{-- Nội dung / Mặt hàng quan tâm --}}
                        <div class="col-12">
                            <label class="form-label small fw-bold text-dark">Nội dung quan tâm / Thông tin thêm <span class="text-danger">*</span></label>
                        ...
                        <div class="col-12 mt-4 text-center">
                            <button type="button" class="btn btn-success btn-lg btn-agent-submit px-5 py-3 w-100 fw-bold shadow">
                                <i class="fa-solid fa-paper-plane me-2"></i> GỬI ĐĂNG KÝ ĐẠI LÝ NGAY
                            </button>
                            <div class="small text-muted mt-2">
                                <i class="fa-solid fa-lock me-1"></i> Thông tin của quý khách được bảo mật tuyệt đối 100%.
                            </div>
                        </div>
                    </div>
                </form>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (submitBtn && agentForm) {
            submitBtn.addEventListener('click', function(e) {
                ...
                submitBtn.innerHTML = '<i class="fa-solid fa-spinner fa-spin me-2"></i> Đang xử lý đăng ký...';
