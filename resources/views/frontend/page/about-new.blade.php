...
@section('seo')
    @include('frontend.layouts.seo', [
        ...
        'description' => 'Tam Nông chuyên cung cấp thực phẩm tươi sạch, thịt bê, thịt gà đồi, chim trĩ, thịt heo sạch đạt chuẩn an toàn vệ sinh thực phẩm cao nhất.',
...
<div class="container about-page-container">
            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    ...
                    <p class="about-hero-desc mb-4">
                        <strong>Tam Nông</strong> tự hào là cầu nối trực tiếp giữa các vùng nuôi trồng đạt chuẩn với bàn ăn của hàng chục nghìn gia đình. Chúng tôi chuyên phân phối thịt bê tươi, thịt gia cầm đồi, thịt heo sạch và đặc sản vùng miền với cam kết chuẩn mực cao nhất về an toàn vệ sinh thực phẩm.
                    </p>
                ...
                <div class="col-lg-5">
                    <div class="about-hero-img-wrap">
                        <img src="{{ asset('assets/images/about_farm_meat.jpg') }}" alt="Thực phẩm sạch Tam Nông" class="about-hero-img">
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-5">
                <div class="position-relative">
                    <img src="{{ asset('assets/images/about_supply_chain.jpg') }}" alt="Quy trình thực phẩm Tam Nông" class="img-fluid rounded-4 shadow-sm w-100">
                </div>
            </div>
            <div class="col-lg-7">
                ...
                <p class="text-muted mb-4" style="line-height: 1.7;">
                    Xuất phát từ nỗi trăn trở về thực phẩm không rõ nguồn gốc trên thị trường, <strong>Tam Nông</strong> được xây dựng với mục tiêu chuẩn hóa chuỗi cung ứng nông sản - thực phẩm sạch từ nông trại đến tay người tiêu dùng.
                </p>
                ...
                <div class="vision-card">
                    ...
                    <p class="vision-card-desc">
                        Trở thành thương hiệu phân phối thực phẩm tươi sống và đặc sản nông nghiệp tin cậy hàng đầu, đồng hành trong mọi gian bếp gia đình và nhà hàng.
                    </p>
                </div>
                ...
                <div class="vision-card">
                    ...
                    <p class="vision-card-desc">
                        Bảo vệ sức khỏe cộng đồng bằng nguồn thực phẩm tươi ngon tự nhiên, không tồn dư hóa chất bảo quản và minh bạch 100% nguồn gốc xuất xứ.
                    </p>
                </div>
                ...
                <div class="vision-card">
                    ...
                    <p class="vision-card-desc">
                        <strong>Tận Tâm</strong> trong phục vụ — <strong>Trung Thực</strong> về chất lượng — <strong>Trách Nhiệm</strong> với sức khỏe người tiêu dùng.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 mt-2">
            <div class="col-md-3">
                <div class="process-step-card">
                    ...
                    <p class="process-step-desc">Gia súc, gia cầm được nuôi thả tự nhiên tại các nông trại đạt tiêu chuẩn an toàn sinh học.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="process-step-card">
                    ...
                    <p class="process-step-desc">100% sản phẩm có chứng nhận kiểm dịch, không chất tăng trọng, không tồn dư kháng sinh.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="process-step-card">
                    ...
                    <p class="process-step-desc">Đóng khay hút chân không, bảo quản lạnh tiêu chuẩn để giữ trọn độ mọng nước và dinh dưỡng.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="process-step-card">
                    ...
                    <p class="process-step-desc">Thùng cách nhiệt chuyên dụng giúp thực phẩm luôn tươi ngon khi đến tay khách hàng.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4 mt-2">
            <div class="col-md-3">
                <div class="pillar-card">
                    ...
                    <p class="pillar-desc">Nói không với hàng ôi đông lạnh lâu ngày. Thịt tươi được sơ chế và phân phối ngay trong ngày.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="pillar-card">
                    ...
                    <p class="pillar-desc">Mọi sản phẩm đều đạt chuẩn kiểm nghiệm an toàn vệ sinh thực phẩm, an tâm tuyệt đối cho trẻ nhỏ và người già.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="pillar-card">
                    ...
                    <p class="pillar-desc">Liên kết trực tiếp với nhà vườn và trang trại giúp tối ưu chi phí trung gian, đem lại mức giá cạnh tranh nhất.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="pillar-card">
                    ...
                    <p class="pillar-desc">Chính sách hỗ trợ đổi trả 100% nếu thực phẩm không đạt chất lượng cam kết hoặc xảy ra sự cố vận chuyển.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="about-cta-banner">
        ...
        <p class="about-cta-desc">
            Hãy liên hệ với chúng tôi ngay hôm nay để đặt mua những phần thực phẩm tươi ngon nhất cho gia đình hoặc đăng ký nhận bảng giá sỉ dành cho đại lý và nhà hàng!
        </p>
        <div class="d-flex justify-content-center gap-3 flex-wrap">
            <a href="{{ route('product.all') }}" class="btn-gold">
                <i class="fa-solid fa-cart-shopping"></i> Đặt mua thực phẩm tươi
            </a>
            <a href="tel:{{ str_replace(' ', '', setting_option('phone', '0932.009.180')) }}" class="btn btn-outline-light rounded-pill px-4 py-2 fw-bold d-inline-flex align-items-center gap-2" style="font-size: 14px;">
