            ...
            <div class="col-lg-8">
                <div class="bg-white rounded-4 shadow-sm p-4 p-md-5 text-center border">
                    ...
                    <p class="text-muted mb-4 mx-auto" style="max-width: 580px;">
                        Chúng tôi đã nhận được thông tin câu hỏi / yêu cầu tư vấn của bạn. Đội ngũ chuyên viên của 3 Nông sẽ liên hệ lại với bạn trong thời gian sớm nhất.
                    </p>

                    <div class="row g-3 justify-content-center mb-4 text-start">
                        <div class="col-md-5">
                            <a href="tel:{{ str_replace(' ', '', setting_option('phone', '0932 009 180')) }}" class="card text-decoration-none border shadow-xs h-100 p-3 rounded-3 text-dark hover-card-lift">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="fw-bold text-success">{{ setting_option('phone', '0932 009 180') }}</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-5">
                            <a href="mailto:{{ setting_option('email', 'tamnong.corp@gmail.com') }}" class="card text-decoration-none border shadow-xs h-100 p-3 rounded-3 text-dark hover-card-lift">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="bg-success bg-opacity-10 text-success rounded-circle p-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="fw-bold text-dark text-truncate" style="max-width: 180px;">{{ setting_option('email', 'tamnong.corp@gmail.com') }}</div>
                                    </div>
                                </div>
                            </a>
                        </div>
