...
<meta name="description" content="{{ $seo_description ?? strip_tags((string) setting_option('seo-description-add')) }}">
<meta property="og:title" content="{{ $seo_title ?? setting_option('og-title') }}" />
<meta property="og:description" content="{{ $seo_description ?? strip_tags((string) setting_option('og-description')) }}" />
